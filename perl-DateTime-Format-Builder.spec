...
cp %{_builddir}/DateTime-Format-Builder-0.83/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-Format-Builder/5586816d65cedc4c52fb3e6704d529fb9535d8fe
if test -f Makefile.PL; then
